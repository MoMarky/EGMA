    ...
    def from_pretrained(self, input_dir=None):
        ...
        if isinstance(self.vision_model, MedCLIPVisionModel):
            ...
            if input_dir is None:
                ...
                input_dir = '/data2/machong/LM_tools/MedCLIP-main/MedCLIP-main/pretrain_weights/medclip-vit-pretrained'
        else:
...
class Hyrachy_MedCLIPVisionModelViT(nn.Module):
    '''take an VIT model as the backbone.
    '''
    def __init__(self, checkpoint=None, medclip_checkpoint=None) -> None:
        '''args:
...
class Hyrachy_ConV_MedCLIPVisionModelViT(nn.Module):
    '''take an VIT model as the backbone.
    '''
    def __init__(self, checkpoint=None, medclip_checkpoint=None) -> None:
        '''args:
...
class Hyrachy_MedCLIPVisionModelViT_GazeEmb(nn.Module):
    '''take an VIT model as the backbone.
    '''
    def __init__(self, checkpoint=None, medclip_checkpoint=None) -> None:
        '''args:
...
class BertEncoder(nn.Module):
    def __init__(self,
        ...
        self.config = BertConfig.from_json_file(r"/data2/machong/LM_tools/MedCLIP-main/MedCLIP-main/configs/bert_config.json")
...
class Hyrachy_MedCLIPModel(nn.Module):
    def __init__(self,
                 vision_cls=MedCLIPVisionModel,
                 checkpoint=None,
                 vision_checkpoint=None,
...
# FILIP Loss,,United Model, inculde img and all sent txt encoder
class Hyrachy_FILIP_MedCLIPModel(nn.Module):
    def __init__(self,
                 vision_cls=MedCLIPVisionModel,
                 checkpoint=None,
                 vision_checkpoint=None,
...
"""SPARC"""
class SPARC_MedCLIPTextModel(nn.Module):
    def __init__(self,
                 bert_type=constants.BERT_TYPE,
                 proj_dim = 512,
                 proj_bias = False) -> None:
...
"""SPARC + FILIP"""
class SPARC_FILIP_MedCLIPModel(nn.Module):
    def __init__(self,
                 vision_cls=MedCLIPVisionModel,
                 checkpoint=None,
                 vision_checkpoint=None,
...
"""SPARC + FILIP + PartGaze"""
class SPARC_FILIP_PartGaze_MedCLIPModel(nn.Module):
    def __init__(self,
                 vision_cls=MedCLIPVisionModel,
                 checkpoint=None,
                 vision_checkpoint=None,
...
"""SPARC + FILIP + PartGaze + ViTBase"""
class SPARC_FILIP_PartGaze_ViTBase_MedCLIPModel(nn.Module):
    def __init__(self,
