...
class ImageTextContrastiveLoss(nn.Module):
    def __init__(self, model, org_clip=False):
        super().__init__()
        self.model = model
        self.org_clip = org_clip
    def forward(self,
        input_ids=None,
        pixel_values=None,
        gaze_hm=None,
...
class FILIP_ImageTextContrastiveLoss(nn.Module):
    def __init__(self, model, org_clip=False):
        super().__init__()
        self.model = model
        self.org_clip = org_clip
...
class FILIP_PartGaze_ImageTextContrastiveLoss(nn.Module):
    def __init__(self, model, org_clip=False):
        super().__init__()
        self.model = model
        self.org_clip = org_clip
