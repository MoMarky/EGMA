...
# BERT_TYPE = '/data2/machong/LM_tools/MedCLIP-main/MedCLIP-main/pretrain_weights/Bio_ClinicalBERT'
BERT_TYPE = '/data2/machong/LM_tools/MGCA-main/weights/emilyalsentzer_Bio_ClinicalBERT/'
# VIT_TYPE = 'microsoft/swin-tiny-patch4-window7-224'
VIT_TYPE = '/data2/machong/LM_tools/MedCLIP-main/MedCLIP-main/pretrain_weights/swin-tiny-patch4-window7-224'
